...
public interface CustomsDeclarationService {
    ...
    TableDTO searchCustomsDeclarationDODTO(SearchBaseDTO searchBaseDTO);

    CustomsDeclarationViewDetailVO findCustomsDeclarationViewDetailResponse(String entryId);

    void printAddOne(String entryId);
}
