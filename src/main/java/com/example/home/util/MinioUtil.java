...
public class MinioUtil {
     ...
     * 上传文件
     */
    public void uploadFile(MultipartFile file, String bucketName, String filePath) throws Exception {
        //判断文件是否为空
        ...
        client.putObject(
                PutObjectArgs.builder().bucket(bucketName).object(filePath).stream(
                        ...
                        .build());
        String url = minioProp.getEndpoint() + "/" + bucketName + "/" + filePath;
        String urlHost = minioProp.getFilHost() + "/" + bucketName + "/" + filePath;
